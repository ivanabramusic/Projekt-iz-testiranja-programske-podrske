...
//Declare a Webdriver variable
    ...
    public void googleSearchTest() throws InterruptedException {
        ...
        WebElement liveGameButton = driver.findElement(By.xpath("//*[@id=\"content-header\"]/div[2]/ul/li[3]/a/div"));
        liveGameButton.click();
        Thread.sleep(5000);

        WebElement message = driver.findElement(By.xpath("//*[@id=\"content-container\"]/div/h3"));
